...
def generate_banner():
    ...
    # Save the output dynamically avoiding hardcoded OS boundaries
    out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'final_youtube_banner_master_2560.png')
